...
public class Rational implements Comparable<Rational> {
    ...
    public Rational(String s) {
        ...
        if (underscorePosition != 0) {
            /* it has the coeff in the front */
            for (i=0; i<underscorePosition; i++) {
                strBuff.append(s.charAt(i));
            }
            coeff = Integer.parseInt(strBuff.toString());
            strBuff.setLength(0);
            for (i=underscorePosition+1; i<slashPosition; i++) {
                strBuff.append(s.charAt(i));
            }
            ...
            coeff = 0;
            for (i=0; i<slashPosition; i++) {
                strBuff.append(s.charAt(i));
            }
            num = Integer.parseInt(strBuff.toString());
        }
        for (i=slashPosition+1; i<s.length(); i++) {
                strBuff.append(s.charAt(i));
            }
            den = Integer.parseInt(strBuff.toString());
    }
